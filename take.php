    ...
    <main>
      <div id="form_div" style="width: 80%;">
          <form  action="" method="post">
            <input type="text" name="city" placeholder="Podaj miasto" class="login_input" required>
            <input type="submit" name="submit_m" value="Wyszukaj" id="submit">
          </form>
        <?php
          require_once('script_diplay_ads.php');
         ?>
      </div>
    </main>
    <footer>
